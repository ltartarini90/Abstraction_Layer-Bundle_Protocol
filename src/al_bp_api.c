        ...
        /*if(bundle_object->spec->blocks.blocks_len > 0)
        {
            for ( i=0; i<bundle_object->spec->blocks.blocks_len; i++ ) {
                printf("Freeing extension block [%d].data at 0x%08X\n",
                                   i, bundle_object->spec->blocks.blocks_val[i].data.data_val);
                free(bundle_object->spec->blocks.blocks_val[i].data.data_val);
            }
            free(bundle_object->spec->blocks.blocks_val);
            bundle_object->spec->blocks.blocks_val = NULL;
        ...
        if(bundle_object->spec->metadata.metadata_len > 0)
        {
            for ( i=0; i<bundle_object->spec->metadata.metadata_len; i++ ) {
                printf("Freeing metadata block [%d].data at 0x%08X\n",
                                   i, bundle_object->spec->metadata.metadata_val[i].data.data_val);
                free(bundle_object->spec->metadata.metadata_val[i].data.data_val);
            }
            free(bundle_object->spec->metadata.metadata_val);
            bundle_object->spec->metadata.metadata_val = NULL;
